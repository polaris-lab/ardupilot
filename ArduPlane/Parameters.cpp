...
const AP_Param::Info Plane::var_info[] = {
    ...
    // @Description: 副翼故障类型。0=无；1=限幅；2=偏置；3=锁定。
    // @Values: 0:None,1:Limit,2:Offset,3:Lock
    // @User: Standard
    ...
    // @Description: 升降舵故障类型。0=无；1=限幅；2=偏置；3=锁定。
    // @Values: 0:None,1:Limit,2:Offset,3:Lock
    // @User: Standard
    ...
    // @Description: 方向舵故障类型。0=无；1=限幅；2=偏置；3=锁定。
    // @Values: 0:None,1:Limit,2:Offset,3:Lock
    // @User: Standard
